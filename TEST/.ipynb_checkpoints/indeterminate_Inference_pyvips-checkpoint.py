...
#                 prob_1, x, y = self.forward_step(batch)
#                 softmax_output_1 = softmax_layer(prob_1)
                
#                 prob_2, x, y = self.forward_step(batch)
#                 softmax_output_2 = softmax_layer(prob_2)
                
#                 prob_3, x, y = self.forward_step(batch)
...
def cut_unlabel_file_to_train(case, tumor_pl, normal_pl):
    ...
    pseudo_label_pkl_path = "/work/jack91630/DATA/PROCESSED_DATA/CASE_UUID/{}_pseudo/{}.pkl".format(project, case)
    wsi_path = "/work/jack91630/DATA/RAW_DATA/RAW_IMAGE/{}.tif".format(case)
