...
class back_out():
    ...
    def remove_patch(self , file_name):
        pseudo_path = "/work/rara0857/DATA/PROCESSED_DATA/CASE_UUID/{}_pseudo/{}.pkl".format(os.getcwd().split('/')[3], self.file_name)
        wsi_path = '/work/rara0857/DATA/RAW_DATA/RAW_IMAGE/{}.tif'.format(self.file_name)
        print(pseudo_path)
        print(wsi_path)
